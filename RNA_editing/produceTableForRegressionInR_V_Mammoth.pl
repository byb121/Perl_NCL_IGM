...
sub Looking_4_common_hereozygous_in_VCF_file_folder_4_regression {
	...
	my $gq_quality_filter = 0; # Phred-scaled p-value of the genotype calling is wrong
	...
	`~/biosofts/BEDTools-Version-2.16.2/bin/intersectBed -wo -a $temp_output_file -b ~/GenomeData/hg19/gencode.v10.annotation.gtf > $temp_output_file_2`;
