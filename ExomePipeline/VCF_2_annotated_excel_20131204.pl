...
print "\n";
print "VCF_2_annotated_excel_20131204.pl says\n";
print "############################################################################################\n";
...
print "# YX: will output annotated Exomiser result if output of Exomiser supplied                 #\n";
print "# YX: If more than one Exomiser files are given, only overlapped variants are counted      #\n";
print "# YX: use gene id annotated by Annovar for Hyperlinks instead of searching                 #\n";
print "# YX: added more annotation to the genes in 'CompoundHeterozygous' sheet.                  #\n";
print "############################################################################################\n";
...
while (my $line=<INPUT>) {
	if ($line !~ m/^Chr\t/) {
		...
		."\t".$elements[11]."\t".$elements[12]."\t".$elements[13]."\t".$elements[15]."\t".$elements[16]."\t".$elements[$length-11]."\t"
		.$elements[$length-10]."\t".$elements[$length-9]."\t".$elements[18]."\t".$elements[19]."\t".$elements[20]."\t".$elements[21]."\t".
		$elements[$length-8]."\t".$elements[$length-7]."\t".$elements[22]."\t".$elements[25].":".$elements[27].":".$elements[29].":".$elements[31]."\t".$elements[46]."\t";
