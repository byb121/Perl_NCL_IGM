...
print "# Minor change: will output \'Everything\' table into a separate file if request, check help!         #\n";
print "#######################################################################################################\n";
...
'exomiserXLS=s' => \$exomiserXLSfiles, 'out=s' => \$output_excel, 'outAll=s' => \$output_excel_everything) || defined $help );
