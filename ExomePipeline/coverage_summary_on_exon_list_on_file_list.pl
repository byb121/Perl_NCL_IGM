...
my $output_file_5x_coverage = $SamplePath."/".$Output_prefix."_5x_coverage_on_exons_of_genes.txt";
my $output_file_10x_coverage = $SamplePath."/".$Output_prefix."_10x_coverage_on_exons_of_genes.txt";
...
print FractionOfLeastCoverageOnExonsOfSamples($SamplePath,  \@Names, 5, $CovFileName, $output_file_5x_coverage);
...
sub AverageCoverageOnExonsOfSamples{
	...
	foreach my $sample (@Names) {
		my $file = $SamplePath."/".$sample."/"."bedtools"."/".$CovFileName;
